...
function register(){
    ...
    if(email==""){
        jQuery("#email_err").html('Please enter your email**');
        is_error='yes';
      }
      if(mobile==""){
        jQuery("#mobile_err").html('Please enter your mobile**');
        is_error='yes';
      }
      if(password==""){
        jQuery("#pass_err").html('Please enter your password**');
        is_error='yes';
      }
    if(is_error==""){
        jQuery.ajax({
            url:'send_register.php',
            type:'POST',
            data:'name='+name+'&email='+email+'&mobile='+mobile+'&password='+password,
            success:function(result){
                if(result=='registered'){
                    jQuery('#email_err').html('Your Email id already axist');
                }
                if(result=='thanks'){
                    jQuery('.form-mess').html('thank you for ragistration');
                }
            }
        });
    }
...
function login(){
    ...
    var error='';
    if(login_id==""){
        jQuery("#login_err").html('please enter your email**');
        error='yes';
    }
    if(login_pass==""){
        jQuery("#password_err").html('please enter your email**');
        error='yes';
    }
    if(error==""){
        jQuery.ajax({
            ...
            if(result=='invalid'){
                jQuery('#login').html('Please enter correct Id and Password');
            }
