                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="category.php?id=<?php echo $get_product['0']['category_id']?>">
                                  <?php echo $get_product['0']['category_name']?></a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                    ...
                    <div class="row">
                                ...
                                <div class="product__big__images">
                                    <div class="portfolio-full-image tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                            <img src="adminthem/upload/<?php echo $get_product['0']['product_img']?>" alt="full-image">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <ul  class="pro__prize">
                                    <li class="old__prize"><?php echo $get_product['0']['product_mrp']?></li>
                                    <li><?php echo $get_product['0']['product_sprice']?></li>
                                </ul>
                                <p class="pro__info"><?php echo $get_product['0']['pdescription']?></p>
                                <div class="ht__pro__desc">
                                    ...
                                    <div class="sin__desc align--left">
                                        ...
                                        <ul class="pro__cat__list">
                                            <li><a href="category.php?id=<?php echo $get_product['0']['category_id']?>">
                                            <?php echo $get_product['0']['category_name']?>  </a></li>
                                        </ul>
                                    </div>
                                    
                                    </div>
                                </div>
                                <a class="fr__btn" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['product_id']?>','add')">Add to Card</a>
                            </div>
                        </div>
                    </div>
                </div>
