                            ...
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img src="adminthem/upload/<?php echo $pimg?>" alt="product img" /></a></td>
                                            <td class="product-name"><a href="#"><?php echo $pname?></a>
                                                <ul  class="pro__prize">
                                                    <li class="old__prize"><?php echo $pmrp?></li>
                                                    <li>$<?php echo $psprice?></li>
                                                </ul>
                                            </td>
                                            <td class="product-price"><span class="amount">$<?php echo $psprice?></span></td>
                                            ...
                                            <td class="product-subtotal">$<?php echo $qty*$psprice ?></td>
