                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product_details.php?id=<?php echo $list['product_id']?>">
                                        
                                            <img src=" adminthem/upload/<?php echo $list['product_img']?>" alt="product images">
                                        </a>
                                    </div>
                                   
                                    <div class="fr__product__inner">
                                        <h4><a href="category.php?id=<?php echo $list['product_id']?>"><?php echo $list['product_name']?></a></h4>
