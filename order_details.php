                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
                                           ...
                                           orderd_product.user_id='$uid' and product.product_id=order_details.product_id")
                                           ...
                                           ?>
                                            ...
                                            <td class="product-add-to-cart"> <?php echo $row['product_name']?></td>
                                                <td class="product-remove"><img src="adminthem/upload/<?php echo $row['product_img']?>"/></td>
